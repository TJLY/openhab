 ...
 */
public class mbusGenericBindingProvider extends
		AbstractGenericBindingProvider implements mbusBindingProvider {
	private static final Logger logger = LoggerFactory
			.getLogger(mbusGenericBindingProvider.class);
	...
	public void processBindingConfiguration(String context, Item item,
		...
		mbusBindingConfig config = new mbusBindingConfig(
